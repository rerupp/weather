...
impl Editor {
    ...
    /// Dispatch a key pressed event to the text editor. The editor will return [EditorResult::Ignored]
    ...
    /// Move the current position to the first character, [EditorResult::Consumed] is returned
    ...
    /// if the position is already at the last character otherwise it returns [EditorResult::Consumed].
    ///
    ...
    /// Delete all character left of the current position. [EditorResult::NotAllowed]  will be returned
    /// if the position is at the first character otherwise it returns [EditorResult::Consumed].
    ///
    ...
    /// if the position is at the last character otherwise it returns [EditorResult::Consumed].
    ///
    ...
    /// if the position is already at the first character otherwise it returns [EditorResult::Consumed].
    ///
    ...
    /// Move the current position 1 character to the right. [EditorResult::NotAllowed] will be returned
    /// if the position is at the last character otherwise it returns [EditorResult::Consumed].
    ///
    ...
    /// if the current position is at the start of the string otherwise it returns [EditorResult::Consumed].
    ///
    ...
    /// if the current position is at the end of the text otherwise it returns [EditorResult::Consumed].
    ///
    ...
    /// if the character is not valid or the text width would be exceeded otherwise it returns [EditorResult::Consumed].
    ///
