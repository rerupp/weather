...
pub mod cmd {
    ...
    /// The other arguments required when [COUNTRY_NAME] is used in conjunction with [CommandMode::Add].
    ...
    /// The other arguments required when [COUNTRY_CODE] is used in conjunction with [CommandMode::Add].
    ...
    /// The other arguments required when [REGION_NAME] is used in conjunction with [CommandMode::Add].
    ...
    /// The other arguments required when [REGION_CODE] is used in conjunction with [CommandMode::Add].
    ...
    /// The other arguments required when [CITY_NAME] is used in conjunction with [CommandMode::Add].
    ...
    /// The other arguments required when [LATITUDE] is used in conjunction with [CommandMode::Add].
    ...
    /// The other arguments required when [LONGITUDE] is used in conjunction with [CommandMode::Add].
    const LONGITUDE_REQS: [&str; 7] = [COUNTRY_NAME, COUNTRY_CODE, REGION_NAME, REGION_CODE, CITY_NAME, LATITUDE, TZ];

    /// The command argument id for the longitude.
    const TZ: &'static str = "TZ";
    /// The other arguments required when [TZ] is used in conjunction with [CommandMode::Add].
