...
build and decided porting the `Python` weather project I built several years ago would be
a good start.
...
A Python [type stubs](py_lib/py_weather_lib.pyi) file has been added to the
