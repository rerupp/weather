//! This module asynchronously gets new weather history from a remote provider.
//!
...
//! a worker thread. The [HistoriesFuture] structure hides how that happens and allows
